...
class AiService {
  ...
  static Future<String> simulateAnalysis({
    ...
    if (total > 5.0) {
      ...
      if (ratio1 > 0.75) {
        return 'You are currently putting significantly more weight on the front of your foot. Try to adjust your posture and shift some pressure back toward your heel. Keep going, you are doing great!';
      } else if (ratio2 > 0.75) {
        return 'You are currently putting more weight on your heel. Focus on stepping forward smoothly through your toes as you walk. Your overall pace is excellent!';
      }
    }

    // Default: Healthy balance and microclimate
